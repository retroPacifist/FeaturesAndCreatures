...
public class FnCEntities {
    public static final RegistrationProvider<EntityType<?>> REGISTRAR = RegistrationProvider.get(Registries.ENTITY_TYPE,
            FnCConstants.MOD_ID);
...
//
  public static final RegistryObject<EntityType<Spear>> SPEAR = createEntity("spear", EntityType.Builder.<Spear>of(Spear::new, MobCategory.MISC).sized(0.5F, 1.0F).clientTrackingRange(4).updateInterval(20));
